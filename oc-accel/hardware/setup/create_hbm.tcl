...
if { [info exists ::env(GLOBAL_ADDRESSING)] } {
	set global_addressing TRUE
} else {
	set global_addressing FALSE
}
...
set_property -dict [list                               \
  ...
  CONFIG.USER_SWITCH_ENABLE_00 $global_addressing      \
...
# 2 stacks
  ...
  set_property -dict [list                               \
     ...
     CONFIG.USER_SWITCH_ENABLE_01 $global_addressing     \
