...
for {set i 0} {$i < $hbm_axi_if_num} {incr i} {
  ...
  connect_bd_net [get_bd_ports S_AXI_p0_HBM_ACLK] [get_bd_pins axi_bram_ctrl_$i/s_axi_aclk]
...
for {set crossbar_index 0} {$crossbar_index < 4} {incr crossbar_index} {
  ...
  set_property -dict {
    ...
    CONFIG.M00_WRITE_ISSUING {4}
    CONFIG.M01_WRITE_ISSUING {4}
    CONFIG.M02_WRITE_ISSUING {4}
    CONFIG.M03_WRITE_ISSUING {4}
    ...
    CONFIG.M01_A00_BASE_ADDR {0x0000000000008000}
    CONFIG.M02_A00_BASE_ADDR {0x0000000000010000}
    CONFIG.M03_A00_BASE_ADDR {0x0000000000018000}
    CONFIG.M00_A00_ADDR_WIDTH {15}
    CONFIG.M01_A00_ADDR_WIDTH {15}
    CONFIG.M02_A00_ADDR_WIDTH {15}
    CONFIG.M03_A00_ADDR_WIDTH {15}
  ...
  if { $crossbar_index < 4} {
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M00_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 0 + $crossbar_index]/S_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 4 + $crossbar_index]/S_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M02_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 8 + $crossbar_index]/S_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M03_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 12 + $crossbar_index]/S_AXI]
  } else {
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M00_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 12 + $crossbar_index]/S_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M01_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 16 + $crossbar_index]/S_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M02_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 20 + $crossbar_index]/S_AXI]
    connect_bd_intf_net [get_bd_intf_pins axi_crossbar_$crossbar_index/M03_AXI] [get_bd_intf_pins axi_bram_ctrl_[expr 24 + $crossbar_index]/S_AXI]
  }
