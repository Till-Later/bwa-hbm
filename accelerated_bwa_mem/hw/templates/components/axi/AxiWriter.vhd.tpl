...
architecture AxiWriter of {{identifier}} is
...
{{^ x_ps_axiStm.type.x_is_axi_stream}}
  report "AxiStm is not an Axi stream type!"; severity failure;
{{/ x_ps_axiStm.type.x_is_axi_stream}}
  alias as_axiStm_ms is {{x_ps_axiStm.identifier_ms}};
  alias as_axiStm_sm is {{x_ps_axiStm.identifier_sm}};
