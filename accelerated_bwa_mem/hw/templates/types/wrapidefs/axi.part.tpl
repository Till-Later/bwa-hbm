...
signal {{.x_wrapname}}_wdata    : std_logic_vector({{.type.x_tdata.x_width}}-1 downto 0);
signal {{.x_wrapname}}_wstrb    : std_logic_vector({{.type.x_tstrb.x_width}}-1 downto 0);
{{? .type.x_tlast}}
...
signal {{.x_wrapname}}_bresp    : std_logic_vector({{.type.x_tresp.x_width}}-1 downto 0);
{{? .type.x_tid}}
...
signal {{.x_wrapname}}_rdata    : std_logic_vector({{.type.x_tdata.x_width}}-1 downto 0);
signal {{.x_wrapname}}_rresp    : std_logic_vector({{.type.x_tresp.x_width}}-1 downto 0);
{{? .type.x_tlast}}
