...
add_cells_to_pblock pblock_hmem [get_cells {
    ...
    oc_func0/fw_afu/action_w/i_Rd_multiplexer_hls_hmem 
    oc_func0/fw_afu/action_w/i_Wr_multiplexer_hls_hmem
    oc_func0/fw_afu/action_w/i_pipeline_stage_axi_hmem_init_bwt 
    oc_func0/fw_afu/action_w/i_pipeline_stage_axi_hmem_results_to_host_manager 
    oc_func0/fw_afu/action_w/i_pipeline_stage_axi_hmem_smem_task_scheduler 
    oc_func0/fw_afu/action_w/i_pipeline_stage_hls_hmem
...
add_cells_to_pblock pblock_action [get_cells {
    ...
    oc_func0/fw_afu/action_w/i_init_bwt/i_hls/init_bwt_host_mem_m_axi_U
    oc_func0/fw_afu/action_w/i_init_bwt/i_hls/init_bwt_card_hbm_p*_m_axi_U
    oc_func0/fw_afu/action_w/i_init_bwt/i_hls/grp_membus_to_HBMbus_fu_706 
...
add_cells_to_pblock pblock_slr0 [get_cells {
    oc_func0/fw_afu/action_w/i_smem_core_*/i_bwt_extend_processor
...
add_cells_to_pblock pblock_slr2 [get_cells {
    oc_func0/fw_afu/action_w/i_sequence_buffer_uram

    oc_func0/fw_afu/action_w/i_smem_core_*/i_smem_buffer
    oc_func0/fw_afu/action_w/i_smem_core_*/i_smem_task_processor
}]
